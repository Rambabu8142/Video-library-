                ...
                <tbody>
                    {
                        videos?.map(video => 
                            <tr key={video.VideoId}>
                                ...
                                <td>
                                    <Link to="/edit-video" className="btn btn-warning"> <span className="bi bi-pen-fill"></span> </Link>
                                    <Link to="/delete-video" className="btn btn-danger ms-2"> <span className="bi bi-trash"></span> </Link>
                                </td>
                            </tr>
                        )
                    }
